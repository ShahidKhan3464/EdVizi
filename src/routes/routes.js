...
const DealsAccounts = lazy(() => import('pages/deals-accounts/deals-accounts'));
const EdVantageNavigator = lazy(() =>
  import('pages/edVantage-navigator/edVantage-navigator')
);
