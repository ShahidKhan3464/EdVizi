...
export const CustomInput = ({
  ...
  type = 'text',
  disabled = false,
  className = 'w-full text-base text-black px-3 py-2.5 rounded-lg border-[0.66px] border-solid border-gray300 bg-white ease-soft appearance-none outline-none transition-all focus:outline-none',
  ...rest
}) => {
